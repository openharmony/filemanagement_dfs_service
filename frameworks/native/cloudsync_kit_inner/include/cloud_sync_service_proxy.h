...
public:
    ...
    int32_t OptimizeStorage(const OptimizeSpaceOptions &optimizeOptions, bool isCallbackValid = false,
        const sptr<IRemoteObject> &optimizeCallback = nullptr) override;
    ...
    int32_t StartFileCache(const std::vector<std::string> &uriVec,
                           ...
                           const sptr<IRemoteObject> &downloadCallback = nullptr,
