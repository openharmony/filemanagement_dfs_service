...
public:
    ...
    void OnStartSyncFinished(const std::string &appPackageName, int32_t errCode) override;
    void OnStopSyncFinished(const std::string &appPackageName, int32_t errCode) override;
