...
#ifndef OHOS_FILEMGMT_CLOUD_DOWNLOADED_CALLBACK_PROXY_H
#define OHOS_FILEMGMT_CLOUD_DOWNLOADED_CALLBACK_PROXY_H
...
private:
    static inline BrokerDelegator<CloudDownloadedCallbackProxy> delegator_;
};
} // namespace OHOS::FileManagement::CloudSync
