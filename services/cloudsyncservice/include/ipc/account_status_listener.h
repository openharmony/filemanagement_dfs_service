...
#ifndef CLOUD_SYNC_SERVICE_ACCOUNT_STATUS_LISTENER_H
#define CLOUD_SYNC_SERVICE_ACCOUNT_STATUS_LISTENER_H
...
#endif // CLOUD_SYNC_SERVICE_ACCOUNT_STATUS_LISTENER_H