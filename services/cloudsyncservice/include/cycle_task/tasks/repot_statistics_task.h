...
#ifndef OHOS_CLOUD_SYNC_SERVICE_REPORT_STATISTICS_TASK_H
#define OHOS_CLOUD_SYNC_SERVICE_REPORT_STATISTICS_TASK_H
...
#endif // OHOS_CLOUD_SYNC_SERVICE_SERVICE_REPORT_STATISTICS_TASK_H