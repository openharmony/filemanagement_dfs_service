 ...
 */
#ifndef FILEMANAGEMENT_DFS_SERVICE_DAEMON_STUB_MOCK_H
#define FILEMANAGEMENT_DFS_SERVICE_DAEMON_STUB_MOCK_H
...
public:
    ...
    MOCK_METHOD3(PushAsset,
                 int32_t(int32_t userId, const sptr<AssetObj> &assetObj, const sptr<IAssetSendCallback> &sendCallback));
...
#endif // FILEMANAGEMENT_DFS_SERVICE_DAEMON_STUB_MOCK_H
