...
#ifndef OHOS_DFS_BATTERYSRVCLENT_MOCK_H
#define OHOS_DFS_BATTERYSRVCLENT_MOCK_H
...
public:
    ...
    static inline std::shared_ptr<DfsBatterySrvClient> dfsBatterySrvClient = nullptr;
};
