...
namespace OHOS {
class OsAccountManagerMethod {
public:
    virtual ~OsAccountManagerMethod() = default;
public:
...
class OsAccountManagerMethodMock : public OsAccountManagerMethod {
public:
