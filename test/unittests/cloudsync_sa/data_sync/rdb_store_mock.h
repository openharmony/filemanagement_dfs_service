...
public:
    ...
    MOCK_METHOD1(RegisterAutoSyncCallback, int(std::shared_ptr<RdbSyncObserver> syncObserver));
    MOCK_METHOD1(UnRegisterAutoSyncCallback, int(std::shared_ptr<RdbSyncObserver> syncObserver));
