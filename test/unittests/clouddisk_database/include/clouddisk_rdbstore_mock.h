...
class transactionMock final : public NativeRdb::Transaction {
public:
    MOCK_METHOD0(Commit, int32_t());
    MOCK_METHOD0(Rollback, int32_t());
    MOCK_METHOD0(Close, int32_t());
    MOCK_METHOD3(Insert, std::pair<int32_t, int64_t>(const std::string &table,
                                                     const Row &row,
    ...
    MOCK_METHOD5(Update, std::pair<int, int>(const std::string &table,
                                             ...
                                             const Values &args,
                                             Resolution resolution));
    MOCK_METHOD3(Update, std::pair<int, int>(const Row &row,
                                             const AbsRdbPredicates &predicates,
                                             Resolution resolution));
    MOCK_METHOD3(Delete, std::pair<int32_t, int32_t>(const std::string &table,
                                                     const std::string &whereClause,
                                                     const Values &args));
