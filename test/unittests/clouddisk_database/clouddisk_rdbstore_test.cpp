 ...
 * @tc.type: FUNC
 */
HWTEST_F(CloudDiskRdbStoreTest, MtimeSetAttrTest1, TestSize.Level1)
{
    const std::string fileName = "Test";
    const std::string parentCloudId = "100";
    const std::string cloudId = "100";
 ...
 * @tc.type: FUNC
 */
HWTEST_F(CloudDiskRdbStoreTest, MtimeSetAttrTest2, TestSize.Level1)
{
    const std::string fileName = "Test";
    const std::string parentCloudId = "100";
    const std::string cloudId = "100";
 ...
 * @tc.type: FUNC
 */
HWTEST_F(CloudDiskRdbStoreTest, MtimeSetAttrTest3, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(CloudDiskRdbStoreTest, MtimeSetAttrTest4, TestSize.Level1)
{
    const std::string fileName = "Test";
    const std::string parentCloudId = "100";
    const std::string cloudId = "100";
 ...
 * @tc.type: FUNC
 */
HWTEST_F(CloudDiskRdbStoreTest, SizeSetAttrTest1, TestSize.Level1)
{
    const std::string fileName = "Test";
    const std::string parentCloudId = "100";
    const std::string cloudId = "100";
 ...
 * @tc.type: FUNC
 */
HWTEST_F(CloudDiskRdbStoreTest, SizeSetAttrTest2, TestSize.Level1)
{
    const std::string fileName = "Test";
    const std::string parentCloudId = "100";
    const std::string cloudId = "100";
 ...
 * @tc.type: FUNC
 */
HWTEST_F(CloudDiskRdbStoreTest, SizeSetAttrTest3, TestSize.Level1)
{
    const std::string fileName = "mock";
    const std::string parentCloudId = "100";
    const std::string cloudId = "100";
 ...
 * @tc.type: FUNC
 */
HWTEST_F(CloudDiskRdbStoreTest, SetAttrTest6, TestSize.Level1)
{
    const std::string fileName = "test";
    const std::string parentCloudId = "100";
    const std::string cloudId = "100";
...
HWTEST_F(CloudDiskRdbStoreTest, CreateTest5, TestSize.Level1)
{
    ...
    auto rdb = make_shared<RdbStoreMock>();
    clouddiskrdbStore_->rdbStore_ = rdb;
    EXPECT_CALL(*insMock, stat(_, _)).WillOnce(Return(-1));
    int32_t ret = clouddiskrdbStore_->Create(cloudId, parentCloudId, fileName, noNeedUpload);
    EXPECT_EQ(ret, E_PATH);
}
...
HWTEST_F(CloudDiskRdbStoreTest, CreateTest6, TestSize.Level1)
{
    ...
    EXPECT_CALL(*insMock, stat(_, _)).WillOnce(DoAll(SetArgPointee<1>(st), Return(0)));
 ...
 * @tc.type: FUNC
 */
HWTEST_F(CloudDiskRdbStoreTest, GenerateNewRowIdTest1, TestSize.Level1)
{
    const std::string cloudId = "100";
 ...
 * @tc.type: FUNC
 */
HWTEST_F(CloudDiskRdbStoreTest, GenerateNewRowIdTest2, TestSize.Level1)
{
    const std::string cloudId = "100";
    const std::string fileName = "testfile";
    int64_t rowId = 0;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(CloudDiskRdbStoreTest, GenerateNewRowIdTest3, TestSize.Level1)
{
    const std::string cloudId = "100";
    const std::string fileName = "testfile";
    int64_t rowId = 0;
...
/**
 * @tc.name: UpdateTHMStatusTest001
...
/**
 * @tc.name: UpdateTHMStatusTest002
 * @tc.desc: Verify the CloudDiskRdbStore::UpdateTHMStatus function
 * @tc.type: FUNC
 * @tc.require: ICPOAK
 */
...
/**
 * @tc.name: UpdateTHMStatusTest003
 * @tc.desc: Verify the CloudDiskRdbStore::UpdateTHMStatus function
 * @tc.type: FUNC
 * @tc.require: ICPOAK
 */
...
/**
 * @tc.name: UpdateTHMStatusTest004
 * @tc.desc: Verify the CloudDiskRdbStore::UpdateTHMStatus function
 * @tc.type: FUNC
 * @tc.require: ICPOAK
 */
...
/**
 * @tc.name: UpdateTHMStatusTest005
 * @tc.desc: Verify the CloudDiskRdbStore::UpdateTHMStatus function
 * @tc.type: FUNC
 * @tc.require: ICPOAK
 */
HWTEST_F(CloudDiskRdbStoreTest, UpdateTHMStatusTest005, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "UpdateTHMStatusTest005 start";
    try {
        shared_ptr<CloudDiskMetaFile> metaFile = make_shared<CloudDiskMetaFile>(100, "", "");
        MetaBase metaBase;
        metaBase.fileType == FILE_TYPE_CONTENT;
    ...
    GTEST_LOG_(INFO) << "UpdateTHMStatusTest005 end";
}
