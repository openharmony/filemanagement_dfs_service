...
const struct stat mockStat = {.st_dev = 0x00012345,
                              .st_ino = 123456789,
                              .st_mode = 00664,
                              .st_nlink = 1,
                              .st_uid = 1000,
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FileOperationsCloudTest, OpenTest008, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "OpenTest008 Start";
    try {
        CloudDiskFuseData data;
        data.userId = 0;
        fuse_req_t req = nullptr;
    ...
    GTEST_LOG_(INFO) << "OpenTest008 End";
}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FileOperationsCloudTest, OpenTest009, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "OpenTest009 Start";
    try {
        CloudDiskFuseData data;
        data.userId = 0;
        fuse_req_t req = nullptr;
    ...
    GTEST_LOG_(INFO) << "OpenTest009 End";
}
...
HWTEST_F(FileOperationsCloudTest, RenameTest003, TestSize.Level1)
{
    ...
    try {
        ...
        EXPECT_CALL(*insMock, fuse_req_userdata(_)).WillOnce(Return(reinterpret_cast<void*>(&data)));
        EXPECT_CALL(*insMock, fuse_reply_err(_, _)).WillOnce(Return(E_OK));
        EXPECT_CALL(*insMock, fuse_req_ctx(_)).WillOnce(Return(ctx));
        fileOperationsCloud_->Rename(req, parent, name, newParent, newName, flags);
        EXPECT_TRUE(true);
    } catch (...) {
        EXPECT_TRUE(false);
...
/**
 * @tc.name: ReleaseTest008
 * @tc.desc: Verify the Release function
 * @tc.type: FUNC
 * @tc.require: issuesI91IOG
 */
HWTEST_F(FileOperationsCloudTest, ReleaseTest008, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "ReleaseTest008 Start";
    try {
        CloudDiskFuseData data;
        fuse_req_t req = nullptr;
        fuse_ino_t ino = 1;
    ...
    GTEST_LOG_(INFO) << "ReleaseTest008 End";
}

/**
 * @tc.name: ReleaseTest009
 * @tc.desc: Verify the Release function
 * @tc.type: FUNC
 * @tc.require: issuesI91IOG
 */
HWTEST_F(FileOperationsCloudTest, ReleaseTest009, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "ReleaseTest009 Start";
    try {
        CloudDiskFuseData data;
        fuse_req_t req = nullptr;
        fuse_ino_t ino = 1;
    ...
    GTEST_LOG_(INFO) << "ReleaseTest009 End";
}

/**
 * @tc.name: ReleaseTest010
 * @tc.desc: Verify the Release function
 * @tc.type: FUNC
 * @tc.require: issuesI91IOG
 */
HWTEST_F(FileOperationsCloudTest, ReleaseTest010, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "ReleaseTest010 Start";
    try {
        CloudDiskFuseData data;
        fuse_req_t req = nullptr;
        fuse_ino_t ino = 1;
    ...
    GTEST_LOG_(INFO) << "ReleaseTest010 End";
}
...
HWTEST_F(FileOperationsCloudTest, LseekTest004, TestSize.Level1)
{
    ...
    try {
        ...
        EXPECT_CALL(*insMock, fuse_reply_err(_, _)).WillOnce(Return(E_OK)).WillRepeatedly(Return(E_OK));
        fileOperationsCloud_->Lseek(req, ino, off, whence, &fi);
        EXPECT_TRUE(true);
    } catch (...) {
        EXPECT_TRUE(false);
 ...
 * @tc.require: issuesI91IOG
 */
HWTEST_F(FileOperationsCloudTest, IoctlTest1, TestSize.Level1)
{
 ...
 * @tc.require: issuesI91IOG
 */
HWTEST_F(FileOperationsCloudTest, IoctlTest2, TestSize.Level1)
{
 ...
 * @tc.require: issuesI91IOG
 */
HWTEST_F(FileOperationsCloudTest, SetXattrTest017, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "SetXattrTest017 Start";
    try {
        CloudDiskFuseData data;
        fuse_req_t req = nullptr;
        fuse_ino_t ino = 0;
        ...
        EXPECT_TRUE(false);
        GTEST_LOG_(INFO) << "SetXattrTest017 ERROR";
    }
    GTEST_LOG_(INFO) << "SetXattrTest017 End";
}
 ...
 * @tc.require: issuesI91IOG
 */
HWTEST_F(FileOperationsCloudTest, SetXattrTest018, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "SetXattrTest018 Start";
    try {
        CloudDiskFuseData data;
        fuse_req_t req = nullptr;
        fuse_ino_t ino = 0;
        ...
        EXPECT_TRUE(false);
        GTEST_LOG_(INFO) << "SetXattrTest018 ERROR";
    }
