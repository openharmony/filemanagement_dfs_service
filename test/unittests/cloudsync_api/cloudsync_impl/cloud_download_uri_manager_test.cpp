...
/**
 * @tc.name: AddPathToUriTest
 * @tc.desc: Verify the AddPathToUri function.
 * @tc.type: FUNC
 * @tc.require: I6H5MH
 */
HWTEST_F(CloudDownloadUriManagerTest, AddPathToUriTest, TestSize.Level1)
{
...
/**
 * @tc.name: RemoveUriTest
 * @tc.desc: Verify the RemoveUri function.
 * @tc.type: FUNC
 * @tc.require: I6H5MH
 */
HWTEST_F(CloudDownloadUriManagerTest, RemoveUriTest, TestSize.Level1)
{
    const std::string path = "file://data/file";
