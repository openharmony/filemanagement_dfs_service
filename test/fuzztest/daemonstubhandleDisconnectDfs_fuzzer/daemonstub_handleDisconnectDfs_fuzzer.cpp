 ...
 */
#include "daemonstub_handleDisconnectDfs_fuzzer.h"
...
void HandleDisconnectDfsFuzzTest(std::shared_ptr<DaemonStub> daemonStubPtr, const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::HandleDisconnectDfsFuzzTest(daemonStubPtr, data, size);
    return 0;
}
