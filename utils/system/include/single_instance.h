...
#ifndef DISTRIBUTEDFILEDAEMON_UTILS_SINGLE_INSTANCE_H
#define DISTRIBUTEDFILEDAEMON_UTILS_SINGLE_INSTANCE_H
...
#endif // DISTRIBUTEDFILEDAEMON_UTILS_SINGLE_INSTANCE_H
