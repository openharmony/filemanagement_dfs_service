...
enum CloudSyncServiceErrCode : ErrCode {
    ...
    E_NOTIFY = 30,
    E_UNKNOWN = 31,
    E_CLOUD_STORAGE_FULL = 32,
    E_LOCAL_STORAGE_FULL = 33,
    E_BUSINESS_MODE_CHANGED = 34,
    E_OSACCOUNT = 35,
    E_USER_LOCKED = 36,
    E_GET_SIZE_ERROR = 37,
    ...
    E_GET_NETWORK_SIGNAL_STRENGTH_FAILED,
 
    E_NETWORK_SIGNAL_STRENGTH_LOW,
    ...
    E_DK_REMOTE_FAIL = E_DK_LOCK_FAIL + 1,
};
...
enum DFSErrCode {
    ...
    ERR_CREATE_SOCKET_FAILED = 2000,
    ERR_LISTEN_SOCKET_FAILED,
    ERR_BIND_SOCKET_FAILED,
...
enum JsErrCode {
    ...
    E_OPERATION_NOT_PERMITTED = FILEIO_SYS_CAP_TAG + 1,
    E_NO_FILE_OR_DIR = FILEIO_SYS_CAP_TAG + 2,
    E_TRY_AGAIN = FILEIO_SYS_CAP_TAG + 10,
    E_INVALID_ARGUMENT = FILEIO_SYS_CAP_TAG + 20,
};
...
const std::unordered_map<int32_t, int32_t> errCodeTable {
    ...
    { E_AGAIN, E_TRY_AGAIN },
    { E_OPERATION_DENY, E_OPERATION_NOT_PERMITTED},
    { E_URI_NOT_EXIST, E_NO_FILE_OR_DIR},
    { E_INVAL_PARAM, E_INVALID_ARGUMENT},
