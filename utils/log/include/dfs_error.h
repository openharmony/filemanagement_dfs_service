...
enum DFSErrCode {
    ...
    /* dfs version */
    ERR_DFS_VERSION_BSAE = 1000,
    ERR_DFS_VERSION_EMPTY = ERR_DFS_VERSION_BSAE + 1,
    ERR_NO_FIND_PACKAGE_NAME = ERR_DFS_VERSION_BSAE + 2,
    ERR_DFS_VERSION_PARSE_EXCEPTION = ERR_DFS_VERSION_BSAE + 3,
    ERR_GET_UDID = ERR_DFS_VERSION_BSAE + 4,
};
