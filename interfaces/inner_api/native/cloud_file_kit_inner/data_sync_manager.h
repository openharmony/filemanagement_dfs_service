...
public:
    ...
    virtual void StopDownloadAndUploadTask();
    ...
    virtual int32_t CleanCache(const std::string &bundleName, const int32_t userId);
    virtual int32_t UpdateCachedFileSize(const std::string &bundleName, const int32_t userId);
    virtual int32_t GetCachedTotalSize(const std::string &bundleName, const int32_t userId, int64_t &totalSize);
