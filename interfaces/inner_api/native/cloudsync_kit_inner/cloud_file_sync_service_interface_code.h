...
enum class CloudFileSyncServiceInterfaceCode {
    ...
    SERVICE_CMD_UNREGISTER_FILE_SYNC_CALLBACK,
    SERVICE_CMD_REGISTER_CALLBACK,
    SERVICE_CMD_REGISTER_FILE_SYNC_CALLBACK,
    SERVICE_CMD_START_SYNC,
    SERVICE_CMD_START_FILE_SYNC,
    SERVICE_CMD_TRIGGER_SYNC,
    SERVICE_CMD_STOP_SYNC,
    SERVICE_CMD_STOP_FILE_SYNC,
    ...
    SERVICE_CMD_REGISTER_FILE_CACHE_CALLBACK,
    SERVICE_CMD_UNREGISTER_DOWNLOAD_FILE_CALLBACK,
    SERVICE_CMD_UNREGISTER_FILE_CACHE_CALLBACK,
    ...
    SERVICE_CMD_STOP_OPTIMIZE_STORAGE
};
} // namespace OHOS::FileManagement::CloudSync
