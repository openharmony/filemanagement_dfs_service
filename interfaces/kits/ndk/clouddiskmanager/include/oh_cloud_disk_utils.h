...
const std::unordered_map<int32_t, CloudDisk_ErrorCode> innerToNErrTable = {
    ...
    {OHOS::FileManagement::CloudDiskService::CloudDiskServiceErrCode::E_PERM, CLOUD_DISK_PERMISSION_DENIED},
    {OHOS::FileManagement::CloudDiskService::CloudDiskServiceErrCode::E_ACCES, CLOUD_DISK_PERMISSION_DENIED},
