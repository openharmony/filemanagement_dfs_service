...
const std::unordered_map<int32_t, CloudDisk_ErrorCode> innerToNErrTable = {
    ...
    {OHOS::FileManagement::CloudDiskService::CloudDiskServiceErrCode::E_PERM,
     static_cast<CloudDisk_ErrorCode>(OHOS::FileManagement::CloudDiskService::CloudDiskServiceErrCode::E_PERM)},
    {OHOS::FileManagement::CloudDiskService::CloudDiskServiceErrCode::E_ACCES,
     static_cast<CloudDisk_ErrorCode>(OHOS::FileManagement::CloudDiskService::CloudDiskServiceErrCode::E_ACCES)},
    ...
    {OHOS::FileManagement::CloudDiskService::CloudDiskServiceErrCode::E_NOT_A_PLACEHOLDER,
     OH_CLOUD_DISK_NOT_A_PLACEHOLDER},
    ...
    {OHOS::FileManagement::CloudDiskService::CloudDiskServiceErrCode::E_NO_SPACE_LEFT, OH_CLOUD_DISK_NO_SPACE_LEFT},
    {OHOS::FileManagement::CloudDiskService::CloudDiskServiceErrCode::E_CALLBACK_NOT_REGISTERED,
     OH_CLOUD_DISK_CALLBACK_NOT_REGISTERED},
    {OHOS::FileManagement::CloudDiskService::CloudDiskServiceErrCode::E_CALLBACK_ALREADY_REGISTERED,
     OH_CLOUD_DISK_CALLBACK_ALREADY_REGISTERED},
    {OHOS::FileManagement::CloudDiskService::CloudDiskServiceErrCode::E_NOT_A_DIRECTORY, OH_CLOUD_DISK_NOT_A_DIRECTORY},
    ...
    {OHOS::FileManagement::CloudDiskService::CloudDiskServiceErrCode::E_FILE_TOO_LARGE, OH_CLOUD_DISK_FILE_TOO_LARGE},
    {OHOS::FileManagement::CloudDiskService::CloudDiskServiceErrCode::E_PLACEHOLDER_CUSTOM_INFO_NOT_FOUND,
     OH_CLOUD_DISK_PLACEHOLDER_CUSTOM_INFO_NOT_FOUND},
    ...
    {OHOS::FileManagement::CloudDiskService::CloudDiskServiceErrCode::E_CANCELLED, OH_CLOUD_DISK_CANCELLED},
    {OHOS::FileManagement::CloudDiskService::CloudDiskServiceErrCode::E_ALREADY_HYDRATED,
    ...
    {OHOS::FileManagement::CloudDiskService::CloudDiskServiceErrCode::E_HYDRATION_TASK_LIMIT_REACHED,
