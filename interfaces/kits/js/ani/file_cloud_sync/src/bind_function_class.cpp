...
const std::string CT = Builder::BuildConstructorName();
const std::string V_SIGN = Builder::BuildSignatureDescriptor({});
const std::string S_SIGN = Builder::BuildSignatureDescriptor({Builder::BuildClass("std.core.String")});
const std::string SB_SIGN = Builder::BuildSignatureDescriptor(
...
static ani_status BindContextOnGallery(ani_env *env)
{
    ...
    std::array methods = {
        ani_native_function{CT.c_str(), V_SIGN.c_str(),
        ...
        ani_native_function{"offProgress", V_SIGN.c_str(), reinterpret_cast<void *>(CloudSyncAni::CloudSyncOff1)},
        ani_native_function{"GallerySyncStart", V_SIGN.c_str(), reinterpret_cast<void *>(CloudSyncAni::CloudSyncStart)},
        ani_native_function{"GallerySyncStop", V_SIGN.c_str(), reinterpret_cast<void *>(CloudSyncAni::CloudSyncStop)},
    };
...
static ani_status BindContextOnCloudFileCache(ani_env *env)
{
    ...
    std::string getCachedTotalSizeSign = Builder::BuildSignatureDescriptor({}, Builder::BuildLong());
    std::array methods = {
        ani_native_function{CT.c_str(), V_SIGN.c_str(),
            reinterpret_cast<void *>(CloudFileCacheAni::CloudFileCacheConstructor)},
        ani_native_function{CT.c_str(), S_SIGN.c_str(),
            reinterpret_cast<void *>(CloudFileCacheAni::CloudFileCacheConstructorWithBundleName)},
        ...
        ani_native_function{"offProgress", V_SIGN.c_str(),
            reinterpret_cast<void *>(CloudFileCacheAni::CloudFileCacheOff1)},
        ani_native_function{"CloudFileCacheStart", S_SIGN.c_str(),
            reinterpret_cast<void *>(CloudFileCacheAni::CloudFileCacheStart)},
        ani_native_function{"CloudFileCacheStop", SB_SIGN.c_str(),
            reinterpret_cast<void *>(CloudFileCacheAni::CloudFileCacheStop)},
        ani_native_function{"cleanCache", S_SIGN.c_str(),
            reinterpret_cast<void *>(CloudFileCacheAni::CloudFileCacheCleanCache)},
        ani_native_function{"cleanFileCache", S_SIGN.c_str(),
            reinterpret_cast<void *>(CloudFileCacheAni::CloudFileCacheCleanFileCache)},
        ani_native_function{"CleanFileCacheInner", V_SIGN.c_str(),
            reinterpret_cast<void *>(CloudFileCacheAni::CloudFileCacheCleanFileCache1)},
        ...
        ani_native_function{"GetCachedTotalSizeInner", getCachedTotalSizeSign.c_str(),
            reinterpret_cast<void *>(CloudFileCacheAni::CloudFileCacheGetCachedTotalSize)}};
...
static ani_status BindContextOnFileSync(ani_env *env)
{
    ...
    std::string getUploadListSign = Builder::BuildSignatureDescriptor(
        {Builder::BuildClass("std.core.Array")}, Builder::BuildClass("std.core.Array"));
    std::array methods = {
        ani_native_function{CT.c_str(), V_SIGN.c_str(), reinterpret_cast<void *>(FileSyncAni::FileSyncConstructor0)},
        ani_native_function{CT.c_str(), S_SIGN.c_str(), reinterpret_cast<void *>(FileSyncAni::FileSyncConstructor1)},
        ...
        ani_native_function{"offProgress", V_SIGN.c_str(), reinterpret_cast<void *>(FileSyncAni::FileSyncOff1)},
        ani_native_function{"FileSyncStart", V_SIGN.c_str(), reinterpret_cast<void *>(FileSyncAni::FileSyncStart)},
        ani_native_function{"FileSyncStop", V_SIGN.c_str(), reinterpret_cast<void *>(FileSyncAni::FileSyncStop)},
        ...
        ani_native_function{"FileSyncUnRegisterUploadProgress", V_SIGN.c_str(),
        ...
        ani_native_function{"FileSyncPauseUpload", S_SIGN.c_str(),
                            reinterpret_cast<void *>(FileSyncAni::FileSyncPauseUpload)},
        ani_native_function{"FileSyncResumeUpload", S_SIGN.c_str(),
...
static ani_status BindContextOnStaticFunction(ani_env *env)
{
    ...
    std::array methods = {
        ...
        ani_native_function{"unregisterChangeInner", S_SIGN.c_str(),
            reinterpret_cast<void *>(CloudSyncAni::UnRegisterChange)},
        ani_native_function{"optimizeStorageInner", V_SIGN.c_str(),
        ...
        ani_native_function{"stopOptimizeSpaceInner", V_SIGN.c_str(),
...
static ani_status BindContextOnDownload(ani_env *env)
{
    ...
    std::array methods = {
        ...
        ani_native_function{"offProgress", V_SIGN.c_str(), reinterpret_cast<void *>(CloudDownloadAni::DownloadOff1)},
        ani_native_function{"DownloadStart", S_SIGN.c_str(), reinterpret_cast<void *>(CloudDownloadAni::DownloadStart)},
        ani_native_function{"DownloadStop", S_SIGN.c_str(), reinterpret_cast<void *>(CloudDownloadAni::DownloadStop)},
    };
